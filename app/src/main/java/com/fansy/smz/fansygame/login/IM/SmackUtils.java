    ...
    */
    ...
    public void sendMessage(String message, String to) {
        try {
            ...
            //Chat mChat = mChatManager.createChat("kenhong@ip-172-31-39-250.ap-northeast-1.compute.internal/Spark");
            Chat mChat = mChatManager.createChat(to + "@" + "ip-172-31-39-250.ap-northeast-1.compute.internal");
